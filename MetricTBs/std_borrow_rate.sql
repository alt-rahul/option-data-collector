-- Standardized borrow rates for top 100 S&P 500 stocks
...
SELECT
    ...
    sn.Ticker,
    br.Date,
    br.Days,       -- standardized tenors: 10, 30, 60, ... 730 days
    br.BorrowRate
...
WHERE br.Date BETWEEN @fromDate AND @toDate
  AND br.SecurityID IN (SELECT SecurityID FROM SP500_Top100)
